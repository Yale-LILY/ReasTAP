...
os.environ["WANDB_PROJECT"] = "reastap_pretrain_march"
    ...
    def __post_init__(self):
        if self.dataset_name is None and self.train_file is None and self.validation_file is None:
            ...
            if self.train_file is not None:
                ...
                assert extension in ["csv", "jsonl", "json"], "`train_file` should be a csv or a json file."
            if self.validation_file is not None:
                extension = self.validation_file.split(".")[-1]
                assert extension in ["csv", "jsonl", "json"], "`validation_file` should be a csv or a json file."
